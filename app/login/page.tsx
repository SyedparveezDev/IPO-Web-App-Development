          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-sm text-[#6366f1] hover:text-[#4f46e5]">
                  Forgot Password?
                </Link>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  type="button"
                  className="w-full flex justify-center items-center px-4 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50"
                >
            ...
            <div className="text-center">
              <Link href="/signup" className="text-sm text-[#6366f1] hover:text-[#4f46e5]">
                Create an account
              </Link>
            </div>
          </form>
